...
// Forward decl's
//
static bool bmp_byte_swap_get ( void );
static void bmp_byte_swap_set ( bool value );

static bool bmp_08_data_read ( ifstream &file_in, unsigned long int width,
			       long int height,  unsigned char *rarray );
static void bmp_08_data_write ( ofstream &file_out, unsigned long int width,
				long int height, unsigned char *rarray );
...
static void bmp_header1_print ( unsigned short int filetype,
				unsigned long int filesize, unsigned short int reserved1,
				unsigned short int reserved2, unsigned long int bitmapoffset );
static bool bmp_header1_read ( ifstream &file_in, unsigned short int *filetype,
			       unsigned long int *filesize, unsigned long int *reserved1,
			       unsigned short int *reserved2, unsigned long int *bitmapoffset );
static void bmp_header1_write ( ofstream &file_out, unsigned short int filetype,
				unsigned long int filesize, unsigned long int reserved1,
				unsigned short int reserved2, unsigned long int bitmapoffset );

static void bmp_header2_print ( unsigned long int size, unsigned long int width,
				long int height,
...
static void bmp_palette_print ( unsigned long int colorsused,
...
static bool bmp_read ( string& file_in_name, unsigned long int *width, long int *height,
		       unsigned char **rarray, unsigned char **garray, unsigned char **barray );

static bool bmp_08_write ( char *file_out_name, unsigned long int width, long int height,
			   unsigned char *rarray, unsigned char *garray, unsigned char *barray );

static bool bmp_24_write ( string& file_out_name, unsigned long int width, long int height,
			   unsigned char *rarray, unsigned char *garray, unsigned char *barray );
...
bool bmp_read ( string& file_in_name, unsigned long int *width, long int *height,
		unsigned char **rarray, unsigned char **garray, unsigned char **barray )
...
int
cs1300bmp_readfile(string& filename, struct cs1300bmp *image)
{
  bool error;
  unsigned char *rarray;
...
int
cs1300bmp_writefile(string& filename, struct cs1300bmp *image)
{
